...
<tiles:insertDefinition name="kendogrid">
    ...
    <script src="<c:url value='/resources/js/kendo/rma/line.js' />"></script>
    <script src="<c:url value='/resources/js/kendo/rma/grid.js' />"></script>
    <script src="<c:url value='/resources/js/kendo/rma/pie.js' />"></script>
    <script src="<c:url value='/resources/js/kendo/rma/index.js' />"></script>
