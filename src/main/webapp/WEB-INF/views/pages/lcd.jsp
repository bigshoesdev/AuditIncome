...
<tiles:insertDefinition name="kendogrid">
    ...
    <script src="<c:url value='/resources/js/kendo/lcd/line.js' />"></script>
    <script src="<c:url value='/resources/js/kendo/lcd/grid.js' />"></script>
    <script src="<c:url value='/resources/js/kendo/lcd/pie.js' />"></script>
    <script src="<c:url value='/resources/js/kendo/lcd/index.js' />"></script>
